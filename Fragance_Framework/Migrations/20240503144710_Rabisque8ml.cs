...
{
    public partial class Rabisque8ml : Migration
    {
        ...
        {           
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RabisqueId = table.Column<int>(type: "int", nullable: false)
                    ...
                    QtdCartucho = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NCM = table.Column<double>(type: "double", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rabisque", x => x.RabisqueId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
        }
